...
enum vkd3d_config_flags
{
    ...
    VKD3D_CONFIG_FLAG_PIPELINE_LIBRARY_NO_SERIALIZE_SPIRV = 0x00020000,
    VKD3D_CONFIG_FLAG_PIPELINE_LIBRARY_SANITIZE_SPIRV = 0x00040000,
    VKD3D_CONFIG_FLAG_PIPELINE_LIBRARY_LOG = 0x00080000,
    VKD3D_CONFIG_FLAG_PIPELINE_LIBRARY_IGNORE_SPIRV = 0x00100000,
    VKD3D_CONFIG_FLAG_GLOBAL_PIPELINE_CACHE = 0x00200000,
};
